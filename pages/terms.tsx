    ...
    <>
      <div className="legal">
        <div className="header">
          <img
            src="/Terms and Conditions.svg"
            alt="Privacy Policy"
            width="120"
            height="120"
          />
          <Heading size={900} className="title">Monad Terms of Service </Heading>
        </div>
        <Paragraph size={500}>
          <div className="section-header">
            <Heading size={700} id="overview">OVERVIEW</Heading>
          ...
          This website is operated by Monad. Throughout the site, the terms
          “we”, “us” and “our” refer to Monad. Monad offers this website,
          ...
          <div className="section-header">
            <Heading size={700} id="section1">Section 1 - Website Terms</Heading>
          ...
          By agreeing to these Terms of Service, you represent (i) that you are
          13 years of age and the minimum age of digital consent in your
          country, (ii) if you are the age of majority in your jurisdiction or
          over, that you have read, understood, and accept to be bound by the
          Terms, and (iii) if you are between 13 (or the minimum age of digital
          consent, as applicable) and the age of majority in your jurisdiction,
          that your legal guardian has reviewed and agrees to these Terms. You
          ...
          <div className="section-header">
            <Heading size={700} id="section2">Section 2 - General Conditions</Heading>
          ...
          <div className="section-header">
            <Heading size={700} id="section5">Section 5 - Optional Tools</Heading>
          ...
          <div className="section-header">
            <Heading size={700} id="section6">Section 6 - Third-Party</Heading>
          ...
          include materials from third-parties. Third-party LinkIcons on this
          ...
          <div className="section-header">
            <Heading size={700} id="section8">Section 8 - Personal Information</Heading>
          ...
          <div className="section-header">
            <Heading size={700} id="section10">Section 10 - Prohibited Uses</Heading>
          ...
          Monad, our directors, officers, employees, affiliates, agents,
          ...
          <div className="section-header">
            <Heading size={700} id="section12">Section 12 - Indemnification</Heading>
          ...
          You agree to indemnify, defend and hold harmless Monad and our parent,
          ...
          of a third-party.
          <div className="section-header">
            <Heading size={700} id="section13">Section 13 - Severability</Heading>
          ...
          provisions.
          <div className="section-header">
            <Heading size={700} id="section14">Section 14 - Termination</Heading>
          ...
          <div className="section-header">
            <Heading size={700} id="section15">Section 15 - Entire Agreement</Heading>
          ...
          changes.
          <div className="section-header">
            <Heading size={700} id="section17">Section 17 - Contact Information</Heading>
          ...
          <Link href="mailto:Kanishq0106@gmail.com">Kanishq0106@gmail.com</Link>
        </Paragraph >
      </div>
      <Footer />
    </>
