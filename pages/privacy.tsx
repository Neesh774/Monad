      ...
      <div className="legal">
        <div className="header title">
          <img
            ...
            height="120"
          />
          <Heading size={900} className="title">
            Monad Privacy Policy
          </Heading>
        </div>
        <Paragraph size={500}>
          Your privacy is important to us. It is Monad&apos;s policy to respect
          ...
          across our website, https://www.monad.codes, and other sites we own
          and operate. This policy is effective as of 7 November 2021 and was
          last updated on 7 November 2021.
          <div className="section-header">
            <Heading size={700} id="section1">
          ...
          incompatible with these purposes: to enable you to access and use our
          website, associated applications, and associated social media
          platforms for internal record keeping and administrative purposes
          ...
          privacy policy.
          <div className="section-header">
            <Heading size={700} id="section10">
              Your Rights and Controlling Your Personal Information
            </Heading>
            <Link href="/privacy#section10">
              <a title="Permalink to this headline">
                <LinkIcon size={20} />
              </a>
            </Link>
          ...
          <div className="section-header">
            <Heading size={700} id="section12">
              Limits of Our Policy
            </Heading>
            <Link href="/privacy#section12">
              <a title="Permalink to this headline">
                <LinkIcon size={20} />
              </a>
            </Link>
          ...
          <div className="section-header">
            <Heading size={700} id="section13">
              Changes to This Policy
            </Heading>
            <Link href="/privacy#section13">
              <a title="Permalink to this headline">
                <LinkIcon size={20} />
              </a>
            </Link>
          ...
          <div className="section-header">
            <Heading size={700} id="section14">
              Contact Us
            </Heading>
            <Link href="/privacy#section14">
              <a title="Permalink to this headline">
                <LinkIcon size={20} />
              </a>
            </Link>
          ...
          us using the following details: Kanishq C Kancharla
